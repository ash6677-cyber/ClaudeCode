        ...
        return (
          <li key={step.id} className="flex shrink-0 items-center gap-1 sm:gap-2">
            ...
            <button
              ...
              className={cn(
                'flex min-h-11 min-w-11 items-center justify-center gap-2 rounded-full py-1.5 pl-1.5 pr-3 text-sm font-medium transition-colors disabled:cursor-not-allowed max-sm:pr-1.5 sm:pointer-fine:min-h-0 sm:pointer-fine:min-w-0 sm:justify-start',
                active
